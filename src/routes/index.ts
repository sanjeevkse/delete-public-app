...
import complaintDepartmentRoutes from "./complaintDepartmentRoutes";
import complaintSectorRoutes from "./complaintSectorRoutes";
...
import formSubmissionRoutes from "./formSubmissionRoutes";
...
import notificationRecipientRoutes from "./notificationRecipientRoutes";
...
router.use("/", complaintDepartmentRoutes);
router.use("/", complaintSectorRoutes);
...
router.use("/notifications", notificationRecipientRoutes);
