...
import scheduleEventRoutes from "./scheduleEventRoutes";
...
import targetedNotificationRoutes from "./targetedNotificationRoutes";
...
router.use("/", scheduleEventRoutes);
...
router.use("/notifications", targetedNotificationRoutes);
