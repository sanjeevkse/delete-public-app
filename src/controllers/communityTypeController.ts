 ...
 */
export const createCommunityType = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const updateCommunityType = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  const { dispName, description, status } = req.body;
  const userId = req.user?.id;
 ...
 */
export const toggleCommunityTypeStatus = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
