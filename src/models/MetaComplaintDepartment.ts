...
interface MetaComplaintDepartmentAttributes {
  id: number;
  dispName: string;
...
class MetaComplaintDepartment
  ...
  implements MetaComplaintDepartmentAttributes
{
  public id!: number;
...
export default MetaComplaintDepartment;
